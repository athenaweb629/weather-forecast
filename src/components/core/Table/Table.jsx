...
export default function (props) {
  ...
  const { THeadData, TBodyData, stickyHeader = false, nopadding } = props;
            ...
            return (
              <TableRow hover role="checkbox" tabIndex={-1} key={val} sx={classes.tableRow}>
                {THeadData.map((column, index) => {
                  ...
                  return (
                    <TableCell key={index} align={column.align} sx={classes.tablebodyCell + nopadding? classes.nopadding: ""}>
